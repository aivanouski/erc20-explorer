...
var exporter = function(address, block) {
  var self = this;
  ...
  self.newEvents.watch(function(err, log) {
    ...
    if (log.event === "Transfer") {
      console.log(log.args._from);
      console.log(log.args._to);
    }
  });
  ...
  self.allEvents.get(function(err, logs) {
    ...
    logs.forEach(function(log) {
      if (log.event === "Transfer") {
        console.log[log.args._from] = log.args._from;
        console.log[log.args._to] = log.args._to;
      }
    });
